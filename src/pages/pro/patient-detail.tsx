...
import { downloadPatientStatusPdf } from '@/lib/pdf';
import type {
  EntryDoc,
  FieldDefinition,
  PeriodicityType,
            ...
            <div className="flex flex-wrap items-start justify-between gap-3">
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  void downloadPatientStatusPdf({
                    filename: `shanti-${slug}-${histFrom}-${histTo}.pdf`,
                    patientName: `${patient.firstName} ${patient.lastName}`,
                    periodLabel: `${formatDateAR(histFrom)} — ${formatDateAR(histTo)}`,
                    templateName,
                    reports,
                  })
                    .catch(() =>
